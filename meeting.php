...
<head>
    ...
    <link id="banSheet" href="Content/themes/blitzer/jquery-ui-1.8.18.custom.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript" src="Scripts/grid.locale-en.js"></script>
    <script src="Scripts/jquery-ui.min.js" type="text/javascript"></script>
    <script language="javascript" type="text/javascript" src="Scripts/jquery.jqGrid.src.js"></script>
    <script language="javascript" type="text/javascript" src="Scripts/jquery.jqGrid.fluid.js"></script>
    <script language="javascript" type="text/javascript" src="Scripts/jqGridHelper.js"></script>
    <script language="javascript" type="text/javascript" src="Scriptsscripts.js"></script>
                        ...
                        <div class="Main_page">
                            ...
                            <div class="row" id="dvDetails" style="display:none;">
                                <div class="col-lg-12">
                                    ...
                                    <form action="/CreateMeeting/Save" id="MyForm" method="post"> <input type="hidden"
                                            id="usrtype" name="usrtype" value="48" />
                                        <input type="hidden" id="mt_id" name="mt_id" />
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Meeting Date*</label>
                                                    <input type="text" name="mt_date" id="mt_date"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtSSName" id="txtSSName"
                                                        class="form-control" placeholder="Enter SS Code" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtPSDName" id="txtPSDName"
                                                        class="form-control" placeholder="Enter PSD Name/ID" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <div class="form-group">
                                                    <input id="submit1" class="btn btn-danger" name="submit1"
                                                        value="Submit" type="button"
                                                        onclick="return SaveData();" />&nbsp;&nbsp;&nbsp;
                                                    <input id="btnCancel" class="btn btn-danger" name="Cancel"
                                                        value="Cancel" type="button" onclick="return CancelData();" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="row" id="dvUpload" style="display:none;">
                                <div class="col-lg-12">
                                    <form action="/CreateMeeting/SaveImage" enctype="multipart/form-data"
                                        id="MyFormPhoto" method="post"> <input type="hidden" id="id" name="id"
                                            value="" />
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ZMP_ZOMTID" id="ZMP_ZOMTID"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Remark*</label>
                                                            <textarea name="mt_remark" id="mt_remark"
                                                                class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <div class="form-group">
                                                    <input id="submit1" class="btn btn-danger" name="submit1"
                                                        value="Submit" type="button"
                                                        onclick="return SaveDataRemark();" />
                                                    <input id="btnCancel" class="btn btn-danger" name="Cancel"
                                                        value="Cancel" type="button"
                                                        onclick="return CancelDataRemark();" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="row" id="dvApprove" style="display:none;">
                                <div class="col-lg-12">
                                    <form action="/CreateMeeting/SaveApprove" enctype="multipart/form-data"
                                        id="MyFormApprove" method="post"> <input type="hidden" id="_id" name="_id"
                                            value="" />
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Remarks*</label>
                                                    <textarea name="mt_approvalremark" id="mt_approvalremark"
                                                        class="form-control" placeholder="Enter Remark"></textarea>
                                            ...
                                            <div class="col-md-6 text-left">
                                                <div class="form-group">
                                                    ...
                                                    <input id="submit1" class="btn btn-danger" name="submit1"
                                                        value="Submit" type="button"
                                                        onclick="return SaveDataApprove();" /> &nbsp;&nbsp;&nbsp;
                                                    <input id="btnCancel" class="btn btn-danger" name="Cancel"
                                                        value="Cancel" type="button"
                                                        onclick="return CancelDataApprove();" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <script type="text/javascript">
                            ...
                            jQuery(document).ready(function () {
                                $("#ZMP_ZOMTID").tokenInput('/ZoomMeetingMaster/GetParticipantList', {
                                    preventDuplicates: true, theme: "facebook", hintText: "Type email or mobile..."
                                });
                                ...
                                jQuery("#list").jqGrid({
                                    ...
                                    colModel: [
                                        { name: 'mt_id', key: true, hidden: true, index: 'mt_id', width: 50, align: 'left', editable: false, searchoptions: { sopt: ['eq', 'ne'] } },
                                        { name: 'mt_date', index: 'mt_date', width: 250, align: 'center', editable: true, searchoptions: { sopt: ['cn', 'eq', 'ne'] } },
                                        { name: 'USERMASTER.USR_USERNAME', index: 'USERMASTER.USR_USERNAME', width: 150, align: 'left', editable: true, searchoptions: { sopt: ['eq', 'ne'] } },
                                        { name: 'USERMASTER1.USR_USERNAME', index: 'USERMASTER1.USR_USERNAME', width: 150, align: 'left', editable: true, searchoptions: { sopt: ['eq', 'ne'] } },
                                        { name: 'USERMASTER2.USR_USERNAME', index: 'USERMASTER2.USR_USERNAME', width: 150, align: 'left', editable: true, searchoptions: { sopt: ['eq', 'ne'] } },
                                        { name: 'mt_status', index: 'mt_status', width: 150, align: 'left', editable: true, searchoptions: { sopt: ['eq', 'ne'] } }
                                    ],
                                    sortname: 'mt_id', sortorder: "desc",
                                    onSelectRow: OSR,
                                    gridComplete: GC,
                                    loadError: LE,
                                    loadComplete: LC
                                ...
                                if ($("#usrtype").val() == "33" || $("#usrtype").val() == "20" || $("#usrtype").val() == "22") {
                                    jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                        ...
                                        onClickButton: function () {
                                            ...
                                            $("#dvDetails").slideDown();
                                            $('#mt_id').val('');
                                            $("#MyForm").find('input[type="text"]').each(function () { $(this).val(''); });
                                        }
                                    });

                                    jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                        caption: "Edit", title: "Edit",
                                        buttonicon: 'ui-icon-pin-s',
                                        onClickButton: function () {
                                            var myGrid = $('#list');
                                    ...
                                    jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                        caption: "Add Photo", title: "Add Photo",
                                        buttonicon: 'ui-icon-pin-s',
                                        onClickButton: function () {
                                            var myGrid = $('#list');
                                            var rowKey = myGrid.getGridParam('selrow');
                                            if (rowKey == undefined) {
                                                ...
                                                $("#MyFormPhoto").find('input[type="text"]').each(function () { $(this).val(''); });
                                            }
                                        }
                                    });
                                }
                                    ...
                                    jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                        ...
                                        onClickButton: function () {
                                            ...
                                            if (rowKey == undefined) {
                                                ...
                                                $("#dvApprove").slideDown();
                                                $('#_id').val(rowKey);
                                                $("#MyFormApprove").find('input[type="text"]').each(function () { $(this).val(''); });
                                            }
                                        }
                                    });
                                }
                                ...
                                jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                    caption: "Export All", title: "Export All",
                                ...
                                jQuery("#list").navGrid("#pager").navButtonAdd('#pager', {
                                    caption: "Export Grid", title: "Export Grid",
                                    buttonicon: 'ui-icon ui-icon-plus',
                                    onClickButton: function () {
                                ...
                                $.fn.serializeObject = function () {
                                    ...
                                    $.each(this.serializeArray(), function (i, o) {
                                        var n = o.name, v = o.value; obj[n]
                                            = obj[n] === undefined ? v : $.isArray(obj[n]) ? obj[n].concat(v) : [obj[n], v];
                                    }); return obj;
                                };
                                $(function () {
                                    $(".datepicker").datetimepicker({ step: 10, format: "d-M-Y H:i" });
                                });
                            });
                            function SaveData() {
                                if (validate()) {
